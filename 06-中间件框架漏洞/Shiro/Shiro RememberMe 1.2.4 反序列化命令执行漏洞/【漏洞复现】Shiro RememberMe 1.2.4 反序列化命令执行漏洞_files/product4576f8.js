...
s&&s.postPageHeightMessage("updatePageHeight"),console.log("financeUtils done");
}catch(n){}
}
function i(){
...
window.reportVid=[];
for(var f=Math.ceil(1e4*Math.random()),g=0,v=_.length;v>g;++g)!function(e){
...
dom:e,
vid:_
}),r=["/mp/videoplayer?video_h=",v,"&video_w=",g,"&scene=",window.source,"&random_num=",f,"&article_title=",encodeURIComponent(window.msg_title.htmlDecode()),"&source=4&vid=",_,"&mid=",appmsgid,"&idx=",itemidx||idx,"&__biz=",biz,"&nodetailbar=",window.is_temp_url?1:0,"&uin=",uin,"&key=",key,"&pass_ticket=",pass_ticket,"&version=",version,"&devicetype=",window.devicetype||"","&wxtoken=",window.wxtoken||"","&sessionid=",window.sessionid||"","&preview=",window.is_temp_url?1:0].join(""),
