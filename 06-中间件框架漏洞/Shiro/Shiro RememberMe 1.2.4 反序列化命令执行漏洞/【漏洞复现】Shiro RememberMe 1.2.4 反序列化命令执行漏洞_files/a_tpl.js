...
for(var e=0;e<r.children.length;e++)if(-1!==t.indexOf(r.children[e].tagName))return!0;
}
function e(r){
for(var e=0;e<a.length;e++)if(r.className.indexOf(a[e])>-1)return!0;
return i.indexOf(r.tagName)>-1;
}
function n(t,a){
var i=t.children;
if(!i.length)return i;
for(var f,c=[],o=0;o<i.length;o++)f=i[o],u.indexOf(f.tagName)>-1||(r(f)&&!e(f)?(c=c.concat(n(f,a)),
a&&(f.isWrapper=!0,c.push(f))):c.push(f));
return c;
}
var t=["P","DIV","SECTION","LI","H1","H2","H3","H4","H5","H6","TABLE"],a=["js_product_container","js_blockquote_wrap"],i=["BLOCKQUOTE"],u=["MPCHECKTEXT"];
return n.paragraphStartIdx=1e6,n;
